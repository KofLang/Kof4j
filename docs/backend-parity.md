...
| `try` aninhado no KofJS | ✅ CORRIGIDO 07/09 (bug 49) | JS `COMP002: try expected KofTryEnd` — `JsTryTailParser` consome o label de saída (done) no caso sem-finally; JVM/Native/Script/JS rodam |
