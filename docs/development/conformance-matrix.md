...
| stdlib kof.validation (S12: formatCpf/formatCep — pontuação BR, face leniente) | `529.982.247-25` / `123` (no-op) / `01310-100` / `12` (no-op) | DONE | DONE | DONE | DONE | `formatBr*` (KofValidationTest; riscv/aarch sob qemu, assert) |
