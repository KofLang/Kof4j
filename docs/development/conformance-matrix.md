...
| stdlib kof.math (S1b.1: lerp/percentage/isInteger/isDecimal — Double puro, SSE2; subset determinístico, NaN só nos compilados via KofMathTest; riscv/aarch = MATH001) | `true` ×15 | DONE | DONE | DONE | DONE | `stdmath2` |
