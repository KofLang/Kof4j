...
| stdlib kof.time (S7a: addDays/diffDays em data ISO String — parse estrito YYYY-MM-DD, inválido => ""/0) | `2024-02-29` / `2023-03-01` / `2025-01-01` / `2023-12-31` / `''` / `''` / `60` / `-60` / `0` | DONE | PARTIAL (TIME002) | DONE | PARTIAL (TIME002) | `stdtime2` |
