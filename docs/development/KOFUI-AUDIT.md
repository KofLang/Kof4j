...
| **UI003** | Elementos: textarea ✅ FEITO 07/09 (`Textarea`); table/tr/td pendentes; select/option ✅ FEITO 07/09 (`Select`); ul/ol/li ✅ FEITO 07/09 (`Ul`/`Ol` data-driven); fieldset, iframe, video/audio, hr pendentes | KofJS | P1 |
