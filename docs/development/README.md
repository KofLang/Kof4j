...
| `plan-stdlib-expansion.md` | STDLIB universal S1–S10: S1–S8+S10/S10a/b ✅ 09-10/09; **MATH001/TIME002 FECHADOS 11/09** (Double math + addDays/diffDays riscv/aarch, B32/B33 — gates removidos, golden qemu). Restam só decisões da mantenedora (format/boundaries, S10c, §89) + itens sem algoritmo no corpus (isNis/ulid) | `EM CURSO` |
...
|---|---|---|
 ...
 | `known-bugs.md` | fila viva: abertos atacáveis = §45 (finally+return, lowerers) + §104b (Object.equals/record-em-coleção Native) + §104c (JS); congelados/regra 6 = §94/§96/§98/§101/§106 (json.encode Map, registrado 11/09); corrigidos 08–11/09: 1–8/10–17/19–20/26 + 39/44/46/48/50/59/62–64/96–103/105 + MATH001/TIME002 | `ABERTO` (fila §45/§104b/§104c) |
