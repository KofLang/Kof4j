...
public final class NativeMcuGcRiscv32 {
    ...
    public static String runtimeAsm() {
        return """
                ...
                # Stub (NATIVE002): not yet implemented for RV32I. Returns empty
                # string. Catalogued in docs/bugs-and-gaps/known-bugs.md §506 (B-4.2).
                # Unreachable from Kof since 396ff7de4+§506 (emitter gates runtime Int).
                ...
                """ + NativeMcuGcRiscv32Mark.runtimeAsm() + """
                .section .rodata
                .Lgc_lbl: .asciz "gc "
                .Lgc_sp: .asciz " "
                .Lgc_nl: .asciz "\\n"
