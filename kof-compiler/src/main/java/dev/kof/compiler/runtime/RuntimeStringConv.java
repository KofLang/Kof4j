...
public final class RuntimeStringConv {
    ...
    public static void emitIntToString(StringBuilder sb) {
        sb.append("""
    ...
    public static void emitCharToString(StringBuilder sb) {
        sb.append("""
    ...
    public static void emitLongToString(StringBuilder sb) {
        sb.append("""
    ...
    public static void emitBoolToString(StringBuilder sb) {
        sb.append("""
    ...
    public static void emitFloatToString(StringBuilder sb) {
        sb.append("""
    ...
    public static void emitDoubleToString(StringBuilder sb) {
        sb.append("""
