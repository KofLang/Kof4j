...
public final class RuntimeGc {
    ...
    public static void emitGc(StringBuilder sb) {
        sb.append("""
            .section .data
            .Lgc_tick: .quad 0
            .section .text
    ...
    public static void emitProcessExit(StringBuilder sb) {
        sb.append("""
            .section .text
    ...
    public static void emitNullError(StringBuilder sb) {
    ...
    public static void emitBoundsError(StringBuilder sb) {
