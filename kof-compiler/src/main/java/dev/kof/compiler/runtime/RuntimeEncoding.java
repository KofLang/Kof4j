...
public final class RuntimeEncoding {
    ...
    public static void emit(StringBuilder sb) {
        ...
        """);
        // ordem de emissão preservada do arquivo único (.s linka todos os
        // .globl kof_encoding_*); split ≤500 em B64/Url.
        RuntimeEncodingB64.emit(sb);
        RuntimeEncodingUrl.emit(sb);
    }
}
